...
ALTER TABLE "device_authorizations" ADD CONSTRAINT "device_authorizations_claimed_by_users_id_fk" FOREIGN KEY ("claimed_by") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
