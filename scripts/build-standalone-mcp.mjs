...
//
//
// There is deliberately no way to bake a token into the archive. Recipients run
// `relai join`, which never puts a long-lived secret in a file someone forwards.
